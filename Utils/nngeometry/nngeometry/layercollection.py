    ...
    def from_model(model, ignore_unsupported_layers=False):
        ...
        for layer, mod in model.named_modules():
            ...
            if mod_class in ['Linear', 'Conv2d', 'BatchNorm1d',
                             'BatchNorm2d', 'GroupNorm', 'InnerFunctionalConv2d', 'InnerFunctionalBatchNorm2d']:
