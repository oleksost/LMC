...
class Conv_Module(nn.Module):                     
  def __init__(self,in_channels, out_channels, kernel_size, track_running_stats, pooling_kernel, pooling_stride=None, pooling_padding=0, affine_bn =True, momentum=1, decode=False, use_bn=True, **kwargs):
    ...
    #   self.decoder=MetaSequential(OrderedDict([
...
class conv_block_base(nn.Module):           
    ...
    class Options:
        ...
        # batchnorm_inside_of_module: bool = 1 #if 'True' batchnorm will be outside of the modules (between the modules)
        use_bn: bool = 1 # -
        momentum_bn = 1. # -
...
class ModularBaseNet(nn.Module):
    ...
    class Options():      
      ...
      #module tpye
      module_type: str =choice('conv', 'linear', 'resnet_block', 'invertible', 'filterwise', 'expert', default='conv')
